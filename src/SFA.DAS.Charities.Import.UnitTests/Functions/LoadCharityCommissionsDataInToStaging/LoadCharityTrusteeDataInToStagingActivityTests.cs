...
public class LoadCharityTrusteeDataInToStagingActivityTests
{
    ...
    private LoadCharityTrusteeDataInToStagingActivity _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new LoadCharityTrusteeDataInToStagingActivity(_charityTrusteeStagingRepositoryMock.Object, _dataHelperMock.Object);
    }
    ...
    public async Task Run_ShouldCallBulkInsert_WhenTrusteeDataIsAvailable()
    {
        ...
        // Act
        await _sut.Run(fileName, stream, _mockedFunctionContext);
    ...
    public void Run_ShouldThrowException_WhenExtractDataStreamFails()
    {
        ...
        // Act
        Func<Task> action = async () => await _sut.Run(fileName, stream, _mockedFunctionContext);
